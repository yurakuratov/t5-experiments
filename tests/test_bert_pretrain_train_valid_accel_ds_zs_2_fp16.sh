...
MODEL_PATH=./tests/runs/test_bert_pretrain_accel_ds_zero_2_fp16

accelerate launch --num_processes $NP --mixed_precision fp16 --use_deepspeed --zero_stage 2 --config_file ./tests/accelerate.yaml run_bert_pretraining_accel.py \
